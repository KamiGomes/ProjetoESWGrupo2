...
{
    public class UsersInfosController : Controller
    {
        private readonly ShelterContext _context;

        public UsersInfosController(ShelterContext context)
        {
            _context = context;
        }
        ...
        // GET: UsersInfos/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: UsersInfos/Create
