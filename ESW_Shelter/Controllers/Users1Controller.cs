...
namespace ESW_Shelter.Controllers
{
    public class Users1Controller : Controller
    {
        ...
        public Users1Controller(ShelterContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,Email,Name,Password,ConfirmedEmail,Street,PostalCode,City,Phone,DateOfBirth,RoleID")] Users users)
        {
            if (id != users.UserID)
            {
                return NotFound();
